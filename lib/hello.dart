...
//   //   All = devices.length;
//   //   if (devices.isEmpty) {
//   //     controller.devices.forEach((key, device) {
//   //       devices.putIfAbsent(device.id!, () => device);
//   //       deviceId.add(device.id.toString());
//   //       // // Add device name and id to dropdown list data
...
//   //
//   //     controller.positions.forEach((key, position) {
//   //       // Add position to the map and list
//   //       positions.putIfAbsent(position.id!, () => position);
//   //       positionId.add(position.id.toString());
//   //
//   //       // Ensure position attributes and speed are properly accessed
//   //       bool isIgnitionOn = position.attributes?['ignition'] ?? false;
//   //       if (isIgnitionOn) {
//   //         egnOn++;
//   //       } else {
//   //         egnOff++;
...
//   //       if (position.speed != null && position.speed! >= 2.7) {
//   //         moving++;
//   //       } else {
//   //         stopped++;
//   //       }
...
//   //   }
//   //
//   //   // Process devices to match with positions and update counts
//   //   devices.forEach((deviceId, device) {
//   //     var position = positions[deviceId];
//   //     if (position != null) {
...
//   //       }
//   //
//   //       // Determine if moving or stopped based on speed and status
//   //       if ( position.speed! >= 2.7 && device.status == 'online') {
//   //         print("DataObject");
...
//   //       }
//   //     } else {
//   //       // Debugging: Log if position is missing for a device
//   //       print('No position found for device ID: $deviceId');
//   //     }
//   //   });
//   //
//   //   // Set loading to false after processing all data
//   //   isLoading = false;
//   // }
//
//
...
//
//           try{
//             // print(positionId[device.id])
//             print(positions[device.id]!.attributes!["ignition"]);
...
//                             child: Text(
//                               device.status != null
//                                   ? utf8.decode(device.status!.codeUnits, allowMalformed: true)
//                                   : 'No Name',
//                               style: TextStyle(fontSize: title, fontWeight: FontWeight.bold),
//                               overflow: TextOverflow.ellipsis,
//                             ),
